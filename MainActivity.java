package com.example.tictacdoey;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intitiiazeBoardStatus();
    }

    private void intitiiazeBoardStatus() {
    ...
    private void checkWinner() {
        ...
        Log.i(TAG,"Inside checkWinner");

        //Horizontal --rows
        for(int i=0; i<3; i++){
            if(boardStatus[i][0] == boardStatus[i][1] && boardStatus[i][0]==
            boardStatus[i][2]){
        ...
        //Vertical -- columns
        for(int i=0; i<3; i++){
            if(boardStatus[0][i] == boardStatus[1][i] && boardStatus[0][i]==
            boardStatus[2][i]){
